...
Full context: boat_main (py3.9) suite run: /tmp/pez-boatmain-suite13.json. Pez: decompile 329/329 OK; compare exact=167 close=49 mismatch=113 error=0 missing_src=0. Decompyle3: decompile 329/329 OK; compare exact=8 mismatch=321 error=0. Pez internal test suite: PASS (incl. prior failures test_listComprehensions.2.7.pyc invalid-free + test_loops2.2.2.pyc hang).

Current target: getopt.pyc (worst_semantic: 0.1554655870445344 in /tmp/pez-boatmain-suite13/pez_compare.json).
...
2) Pick next mismatch from `/tmp/pez-boatmain-suite13/pez_compare.json` (worst_semantic then worst_seq).
