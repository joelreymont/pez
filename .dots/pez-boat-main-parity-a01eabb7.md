...
Full context: boat_main (py3.9) suite run: /tmp/pez-boatmain-suite14.json. Pez: decompile 329/329 OK; compare exact=167 close=51 mismatch=111 error=0 missing_src=0. Decompyle3: decompile 329/329 OK; compare exact=8 mismatch=321 error=0. Pez internal test suite: PASS (incl. prior failures test_listComprehensions.2.7.pyc invalid-free + test_loops2.2.2.pyc hang).

Current target: calendar.pyc (worst_semantic: 0.1591111111111111 in /tmp/pez-boatmain-suite14/pez_compare.json).
...
2) Pick next mismatch from `/tmp/pez-boatmain-suite14/pez_compare.json` (worst_semantic then worst_seq).
