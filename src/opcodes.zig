...
/// Python 3.1-3.5 opcode byte values (variable-length instructions like Python 2)
...
const opcode_table_3_1 = [_]?Opcode{
    ...
    .UNARY_INVERT, // 15
    null, // 16
    null, // 17 - SET_ADD moved to 146 in 3.1+
    null, // 18 - LIST_APPEND moved to 145 in 3.1+
    .BINARY_POWER, // 19
    .BINARY_MULTIPLY, // 20
    null, // 21
    .BINARY_MODULO, // 22
...
pub fn getOpcodeTable(ver: Version) []const ?Opcode {
    ...
    if (ver.gte(3, 1)) return &opcode_table_3_1; // Python 3.1-3.5
